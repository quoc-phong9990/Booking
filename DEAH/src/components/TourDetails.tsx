              ...
              <nav aria-label="breadcrumb" className="breadcrumb-nav wow fadeInUp" data-wow-delay="0.1s">
                <ul className="breadcrumb listing">
                  ...
                  <li className="breadcrumb-item single-list" aria-current="page">
                    <Link to="#" className="single active">Chi tiết tour du lịch</Link>
                  </li>
                </ul>
              </nav>
            </div>
                        ...
                        <div className="row justify-content-center">
                          <div className="col-xl-7 col-lg-7">
                            <div className="section-title text-center mx-605 mx-auto position-relative mb-60">
                              ...
                              <h4 className="title">Hãy lựa chọn Khách sạn mà bạn yêu thích nhất</h4>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="container">
                        <div className="row">
                          ...
                          <div className="d-grid gap-2">
                            <Link to={`/payment/${id}`} className="btn btn-primary btn-lg">
                              Đặt Lịch Ngay
                            </Link>
                          </div>
                        </div>
