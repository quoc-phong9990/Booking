                                        ...
                                        <div style="width: calc(40%); ">
                                            ...
                                            <select class="form-control mt-2" name="role">
                                                ...
                                                <option @if (request()->role == 1) selected @endif
                                                    value="1">
                                                    Quản trị</option>
                                                <option @if (isset(request()->role) && request()->role == 0) selected
                                                    @endif
                                                    value="0">
                                                    Người dùng</option>
                                            </select>
                                        ...
                                        <div style="width: calc(40%); ">
                                            ...
                                            <select class="form-control mt-2" name="is_active">
                                                ...
                                                <option @if (request()->is_active == 1) selected @endif
                                                    value="1">
                                                    Kích hoạt</option>
                                                <option @if (isset(request()->is_active) && request()->is_active == 0)
                                                    selected @endif
                                                    value="0">
                                                    Khóa</option>
                                            </select>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="border-0 bg-white edit-item-btn showEdit" data-bs-toggle="modal"
                                        data-bs-target="#showModal" data-edit-role="{{ $user->role }}"
                                        data-edit-active="{{ $user->is_active }}" data-edit-id="{{ $user->id }}">
