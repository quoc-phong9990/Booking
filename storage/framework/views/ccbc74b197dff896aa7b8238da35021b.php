                                            ...
                                            <div style="width: calc(40%); ">
                                                ...
                                                <select class="form-control mt-2" name="role">
                                                    ...
                                                    <option <?php if(request()->role == 1): ?> selected <?php endif; ?>
                                                        value="1">
                                                        Quản trị</option>
                                                    <option <?php if(isset(request()->role) && request()->role == 0): ?> selected <?php endif; ?>
                                                        value="0">
                                                        Người dùng</option>
                                                </select>
                                            </div>
                                            <div style="width: calc(40%); ">
                                                ...
                                                <select class="form-control mt-2" name="is_active">
                                                    ...
                                                    <option <?php if(request()->is_active == 1): ?> selected <?php endif; ?>
                                                        value="1">
                                                        Kích hoạt</option>
                                                    <option <?php if(isset(request()->is_active) && request()->is_active == 0): ?> selected <?php endif; ?>
                                                        value="0">
                                                        Khóa</option>
                                                </select>
                                            </div>
                                ...
                                <?php if(count($users) > 0): ?>
                                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td> <?php
                                                echo $user->role == 1
                                                    ? '<span class="badge bg-primary-subtle text-primary text-uppercase">Quản trị</span>'
                                                    : '<span class="badge bg-warning-subtle text-warning text-uppercase">Người dùng</span>';
                                            ?></td>
                                            <td>
                                                <?php
                                            ...
                                            <td>
                                                <button class="border-0 bg-white edit-item-btn showEdit"
                                                    ...
                                                    data-edit-role="<?php echo e($user->role); ?>"
                                                    data-edit-active="<?php echo e($user->is_active); ?>"
                                                    data-edit-id="<?php echo e($user->id); ?>">
